          ...
          >
            <Link href="/projects">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group px-8 py-4 bg-primary text-primary-foreground rounded-lg font-medium flex items-center gap-2 hover:shadow-xl hover:shadow-primary/25 transition-shadow"
              >
            ...
            <Link href="/blog">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="group px-8 py-4 glass rounded-lg font-medium flex items-center gap-2 hover:bg-primary/10 transition-colors"
              >
