              ...
              >
                <Link href={venture.link}>
                  <motion.div 
                    ...
                    className={`p-8 border border-foreground/10 hover:border-primary/50 transition-all duration-300 h-full ${
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-foreground/90 mb-4">
                      {venture.description}
                    </p>
