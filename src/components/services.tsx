            ...
            return (
              ...
              >
                <div className="h-full p-10 border border-foreground/10 hover:border-foreground/30 transition-all duration-300 rounded-xl">
                  ...
                  <p className="text-base sm:text-lg text-foreground/90 mb-6 leading-relaxed">{service.description}</p>
                  
                  <p className="text-sm sm:text-base italic text-foreground/70 pt-6 border-t border-foreground/5">
