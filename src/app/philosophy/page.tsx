    ...
    <section className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-background font-jost">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 tracking-wide text-foreground">
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-r-lg pl-6 py-6 border-l-4 border-primary bg-primary/5"
          >
        ...
        >
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-center mb-10 max-w-xl mx-auto text-foreground/70"
          >
            ...
            {methods.map((method, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative bg-card rounded-xl p-6 h-full transition-all duration-300 border border-border hover:border-primary/30">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/work">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="px-8 py-4 font-bold rounded-lg transition-all bg-transparent border-2 border-primary text-foreground hover:bg-primary/10"
              >
                View Work
              </motion.button>
            </Link>
            <Link href="/contact">
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="px-8 py-4 font-bold flex items-center justify-center gap-2 rounded-lg transition-all bg-primary text-primary-foreground hover:bg-primary/90"
              >
                Get in Touch
