...
(
  ...
  'upland-spark-token',
  'Upland',
  'Launched SPARK token ecosystem bringing 100K+ users into Web3 gaming with true digital property ownership.',
  ...
  'Successfully onboarded 100K users to Web3, creating a sustainable economy where players earn real value.',
  'Web3/Gaming',
  true,
  ARRAY['Solidity', 'Web3.js', 'React', 'Node.js', 'EOS Blockchain'],
  '{"users": "100K+", "token": "SPARK", "growth": "15x revenue", "model": "Play-to-earn"}',
  '2022-03-01',
  '2023-03-01'
),
(
